...
//    virtual float SpecificAdhesion() = 0; //cn_sand значение удельного сцепления (cn), МПа const int &soilNumber
//    virtual float FirstSpecificAdhesion() = 0; //cn_I
//    virtual float SecondSpecificAdhesion() = 0; //cn_II

//    virtual float AngleInternalFriction() = 0; //fn_sand значение угла внутреннего трения (fn), д.ед
//    virtual float FirstAngleInternalFriction() = 0; //
//    virtual float SecondAngleInternalFriction() = 0;
