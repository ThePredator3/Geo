...
//    SoilName soilName{};
//
//    if (m_soilResistivity > sandData.specificAdhesion[0][9])
//    {
//        m_soilResistivity = sandData.specificAdhesion[0][9];
//    }
//    else if (m_soilResistivity < sandData.specificAdhesion[0][0])
//    {
//        m_soilResistivity = sandData.specificAdhesion[0][0];
//    }
//
//    for (int i = 0; i < 10; i++)
//    {
//        if (m_soilResistivity >= sandData.specificAdhesion[0][i])
//        {
//            min = i;
//            max = i + 1;
//        }
//    }
//
//    float minSoilResistivity = sandData.specificAdhesion[0][min];
//    float maxSoilResistivity = sandData.specificAdhesion[0][max];
//    float minSpecificAdhesion = sandData.specificAdhesion[soilName][min];
//    float maxSpecificAdhesion = sandData.specificAdhesion[soilName][max];
//
//    m_specificAdhesion = minSpecificAdhesion + (maxSpecificAdhesion - minSpecificAdhesion) /
//            (maxSoilResistivity - minSoilResistivity) * (maxSoilResistivity - m_soilResistivity);
//
//    return m_specificAdhesion;
//}
//
//float Sand::FirstSpecificAdhesion()
//{
//    m_firstSpecificAdhesion = m_specificAdhesion / 1.5f;
//
//    return m_firstSpecificAdhesion;
//}
//
//float Sand::SecondSpecificAdhesion()
//{
//    m_secondSpecificAdhesion = m_specificAdhesion;
//
//    return m_secondSpecificAdhesion;
//}
//
...
//    SoilName soilName{};
//
//    if (m_soilResistivity > sandData.angleInternalFriction[0][9])
//    {
//        m_soilResistivity = sandData.angleInternalFriction[0][9];
//    }
//    else if (m_soilResistivity < sandData.angleInternalFriction[0][0])
//    {
//        m_soilResistivity = sandData.angleInternalFriction[0][0];
//    }
//
//    for (int i = 0; i < 10; i++)
//    {
//        if (m_soilResistivity >= sandData.angleInternalFriction[0][i])
//        {
//            min = i;
//            max = i + 1;
//        }
//    }
//
//    float minSoilResistivity = sandData.angleInternalFriction[0][min];
//    float maxSoilResistivity = sandData.angleInternalFriction[0][max];
//    float minAngleInternalFriction = sandData.angleInternalFriction[soilName][min];
//    float maxAngleInternalFriction = sandData.angleInternalFriction[soilName][max];
//
//    m_angleInternalFriction = minAngleInternalFriction + (maxAngleInternalFriction - minAngleInternalFriction) /
//                                               (maxSoilResistivity - minSoilResistivity) *
//                                               (maxSoilResistivity - m_soilResistivity);
//
//    return m_angleInternalFriction;
//}
//
//float Sand::FirstAngleInternalFriction()
//{
//    m_firstAngleInternalFriction = m_angleInternalFriction / 1.1f;
//
//    return m_firstAngleInternalFriction;
//}
//
//float Sand::SecondAngleInternalFriction()
//{
//    m_secondAngleInternalFriction = m_angleInternalFriction;
//
//    return m_secondAngleInternalFriction;
